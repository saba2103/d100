...
const FIELD_GROUPS = [
  {
    ...
    fields: [
      ...
      { key: "standard_weight_kg",              label: "Standard Weight",           unit: "kg",   type: "decimal" },
      { key: "bmi",                             label: "BMI",                       unit: "",     type: "decimal" },
      { key: "body_fat_pct",                    label: "Body Fat",                  unit: "%",    type: "decimal" },
      { key: "body_fat_kg",                     label: "Body Fat Mass",             unit: "kg",   type: "decimal" },
      { key: "lean_mass_kg",                    label: "Lean Mass",                 unit: "kg",   type: "decimal" },
      { key: "heart_rate_bpm",                  label: "Heart Rate",               unit: "bpm",  type: "integer" },
      { key: "health_score",                    label: "Health Score",              unit: "/100", type: "integer" },
      { key: "total_body_water_kg",             label: "Total Body Water",          unit: "kg",   type: "decimal" },
      { key: "weight_control_kg",               label: "Weight Control",            unit: "kg",   type: "decimal" },
    ],
  },
  {
    label: "Bone & Muscle",
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "subcutaneous_fat_kg",             label: "Subcutaneous Fat Mass",     unit: "kg",   type: "decimal" },
      { key: "visceral_fat_level",              label: "Visceral Fat Level",        unit: "",     type: "integer" },
      { key: "trunk_fat_mass_kg",               label: "Trunk Fat Mass",            unit: "kg",   type: "decimal" },
      { key: "trunk_fat_ratio_pct",             label: "Trunk Fat Ratio",           unit: "%",    type: "decimal" },
      { key: "body_water_pct",                  label: "Body Water",                unit: "%",    type: "decimal" },
      { key: "protein_pct",                     label: "Protein Ratio",             unit: "%",    type: "decimal" },
      { key: "recommended_calorie_intake_kcal", label: "Recommended Calories",      unit: "kcal", type: "integer" },
    ],
  },
  {
    label: "Metabolic",
  ...
  },
  {
    label: "More",
    fields: [
      { key: "waist_hip_ratio",                 label: "Waist Hip Ratio",           unit: "",     type: "decimal" },
      { key: "intracellular_water_kg",          label: "Intracellular Water",       unit: "kg",   type: "decimal" },
      { key: "extracellular_water_kg",          label: "Extracellular Water",       unit: "kg",   type: "decimal" },
      { key: "protein_mass_kg",                 label: "Protein Mass",              unit: "kg",   type: "decimal" },
      { key: "mineral_mass_kg",                 label: "Mineral Mass",              unit: "kg",   type: "decimal" },
    ],
  },
  {
    label: "Segmental — Arms",
    fields: [
      { key: "left_arm_fat_ratio_pct",          label: "L-Arm Fat Ratio",           unit: "%",    type: "decimal" },
      { key: "right_arm_fat_ratio_pct",         label: "R-Arm Fat Ratio",           unit: "%",    type: "decimal" },
      { key: "left_arm_fat_mass_kg",            label: "L-Arm Fat Mass",            unit: "kg",   type: "decimal" },
      { key: "right_arm_fat_mass_kg",           label: "R-Arm Fat Mass",            unit: "kg",   type: "decimal" },
      { key: "left_arm_muscle_ratio_pct",       label: "L-Arm Muscle Ratio",        unit: "%",    type: "decimal" },
      { key: "right_arm_muscle_ratio_pct",      label: "R-Arm Muscle Ratio",        unit: "%",    type: "decimal" },
      { key: "left_arm_muscle_mass_kg",         label: "L-Arm Muscle Mass",         unit: "kg",   type: "decimal" },
      { key: "right_arm_muscle_mass_kg",        label: "R-Arm Muscle Mass",         unit: "kg",   type: "decimal" },
    ],
  },
  {
    label: "Segmental — Legs",
    fields: [
      { key: "left_leg_fat_ratio_pct",          label: "L-Leg Fat Ratio",           unit: "%",    type: "decimal" },
      { key: "right_leg_fat_ratio_pct",         label: "R-Leg Fat Ratio",           unit: "%",    type: "decimal" },
      { key: "left_leg_fat_mass_kg",            label: "L-Leg Fat Mass",            unit: "kg",   type: "decimal" },
      { key: "right_leg_fat_mass_kg",           label: "R-Leg Fat Mass",            unit: "kg",   type: "decimal" },
      { key: "left_leg_muscle_ratio_pct",       label: "L-Leg Muscle Ratio",        unit: "%",    type: "decimal" },
      { key: "right_leg_muscle_ratio_pct",      label: "R-Leg Muscle Ratio",        unit: "%",    type: "decimal" },
      { key: "left_leg_muscle_mass_kg",         label: "L-Leg Muscle Mass",         unit: "kg",   type: "decimal" },
      { key: "right_leg_muscle_mass_kg",        label: "R-Leg Muscle Mass",         unit: "kg",   type: "decimal" },
    ],
  },
];
    ...
    const loadMeasurement = async () => {
      ...
      if (data) {
        ...
        setForm({
          ...
          standard_weight_kg: toStr(data.standard_weight_kg),
          bmi: toStr(data.bmi),
          body_fat_pct: toStr(data.body_fat_pct),
          body_fat_kg: toStr(data.body_fat_kg),
          lean_mass_kg: toStr(data.lean_mass_kg),
          heart_rate_bpm: toStr(data.heart_rate_bpm),
          health_score: toStr(data.health_score),
          total_body_water_kg: toStr(data.total_body_water_kg),
          weight_control_kg: toStr(data.weight_control_kg),
          bone_mass_kg: toStr(data.bone_mass_kg),
          skeletal_muscle_mass_kg: toStr(data.skeletal_muscle_mass_kg),
          skeletal_muscle_pct: toStr(data.skeletal_muscle_pct),
          subcutaneous_fat_pct: toStr(data.subcutaneous_fat_pct),
          subcutaneous_fat_kg: toStr(data.subcutaneous_fat_kg),
          visceral_fat_level: toStr(data.visceral_fat_level),
          trunk_fat_mass_kg: toStr(data.trunk_fat_mass_kg),
          trunk_fat_ratio_pct: toStr(data.trunk_fat_ratio_pct),
          body_water_pct: toStr(data.body_water_pct),
          protein_pct: toStr(data.protein_pct),
          recommended_calorie_intake_kcal: toStr(data.recommended_calorie_intake_kcal),
          bmr_kcal: toStr(data.bmr_kcal),
          metabolic_age: toStr(data.metabolic_age),
          waist_hip_ratio: toStr(data.waist_hip_ratio),
          intracellular_water_kg: toStr(data.intracellular_water_kg),
          extracellular_water_kg: toStr(data.extracellular_water_kg),
          protein_mass_kg: toStr(data.protein_mass_kg),
          mineral_mass_kg: toStr(data.mineral_mass_kg),
          left_arm_fat_ratio_pct: toStr(data.left_arm_fat_ratio_pct),
          right_arm_fat_ratio_pct: toStr(data.right_arm_fat_ratio_pct),
          left_arm_fat_mass_kg: toStr(data.left_arm_fat_mass_kg),
          right_arm_fat_mass_kg: toStr(data.right_arm_fat_mass_kg),
          left_arm_muscle_ratio_pct: toStr(data.left_arm_muscle_ratio_pct),
          right_arm_muscle_ratio_pct: toStr(data.right_arm_muscle_ratio_pct),
          left_arm_muscle_mass_kg: toStr(data.left_arm_muscle_mass_kg),
          right_arm_muscle_mass_kg: toStr(data.right_arm_muscle_mass_kg),
          left_leg_fat_ratio_pct: toStr(data.left_leg_fat_ratio_pct),
          right_leg_fat_ratio_pct: toStr(data.right_leg_fat_ratio_pct),
          left_leg_fat_mass_kg: toStr(data.left_leg_fat_mass_kg),
          right_leg_fat_mass_kg: toStr(data.right_leg_fat_mass_kg),
          left_leg_muscle_ratio_pct: toStr(data.left_leg_muscle_ratio_pct),
          right_leg_muscle_ratio_pct: toStr(data.right_leg_muscle_ratio_pct),
          left_leg_muscle_mass_kg: toStr(data.left_leg_muscle_mass_kg),
          right_leg_muscle_mass_kg: toStr(data.right_leg_muscle_mass_kg),
        });
        if (data.source === "cult_scale") {
          setParsed({
            measured_at: data.measured_at,
            weight_kg: data.weight_kg,
            standard_weight_kg: data.standard_weight_kg,
            bmi: data.bmi,
            ...
            weight_control_kg: data.weight_control_kg,
            ...
            subcutaneous_fat_kg: data.subcutaneous_fat_kg,
            visceral_fat_level: data.visceral_fat_level,
            trunk_fat_mass_kg: data.trunk_fat_mass_kg,
            trunk_fat_ratio_pct: data.trunk_fat_ratio_pct,
            body_water_pct: data.body_water_pct,
            protein_pct: data.protein_pct,
            recommended_calorie_intake_kcal: data.recommended_calorie_intake_kcal,
            bmr_kcal: data.bmr_kcal,
            metabolic_age: data.metabolic_age,
            waist_hip_ratio: data.waist_hip_ratio,
            intracellular_water_kg: data.intracellular_water_kg,
            extracellular_water_kg: data.extracellular_water_kg,
            protein_mass_kg: data.protein_mass_kg,
            mineral_mass_kg: data.mineral_mass_kg,
            left_arm_fat_ratio_pct: data.left_arm_fat_ratio_pct,
            right_arm_fat_ratio_pct: data.right_arm_fat_ratio_pct,
            left_arm_fat_mass_kg: data.left_arm_fat_mass_kg,
            right_arm_fat_mass_kg: data.right_arm_fat_mass_kg,
            left_arm_muscle_ratio_pct: data.left_arm_muscle_ratio_pct,
            right_arm_muscle_ratio_pct: data.right_arm_muscle_ratio_pct,
            left_arm_muscle_mass_kg: data.left_arm_muscle_mass_kg,
            right_arm_muscle_mass_kg: data.right_arm_muscle_mass_kg,
            left_leg_fat_ratio_pct: data.left_leg_fat_ratio_pct,
            right_leg_fat_ratio_pct: data.right_leg_fat_ratio_pct,
            left_leg_fat_mass_kg: data.left_leg_fat_mass_kg,
            right_leg_fat_mass_kg: data.right_leg_fat_mass_kg,
            left_leg_muscle_ratio_pct: data.left_leg_muscle_ratio_pct,
            right_leg_muscle_ratio_pct: data.right_leg_muscle_ratio_pct,
  ...
  const handleAIExtract = async () => {
    ...
    try {
      ...
      const parsedMeasurement: ParsedMeasurement = {
        ...
        standard_weight_kg: data.standard_weight_kg ?? null,
        bmi: data.bmi ?? null,
        ...
        total_body_water_kg: data.total_body_water_kg ?? null,
        weight_control_kg: data.weight_control_kg ?? null,
        ...
        subcutaneous_fat_kg: data.subcutaneous_fat_kg ?? null,
        visceral_fat_level: data.visceral_fat_level ?? null,
        trunk_fat_mass_kg: data.trunk_fat_mass_kg ?? null,
        trunk_fat_ratio_pct: data.trunk_fat_ratio_pct ?? null,
        body_water_pct: data.body_water_pct ?? null,
        protein_pct: data.protein_pct ?? null,
        recommended_calorie_intake_kcal: data.recommended_calorie_intake_kcal ?? null,
        bmr_kcal: data.bmr_kcal ?? null,
        metabolic_age: data.metabolic_age ?? null,
        waist_hip_ratio: data.waist_hip_ratio ?? null,
        intracellular_water_kg: data.intracellular_water_kg ?? null,
        extracellular_water_kg: data.extracellular_water_kg ?? null,
        protein_mass_kg: data.protein_mass_kg ?? null,
        mineral_mass_kg: data.mineral_mass_kg ?? null,
        left_arm_fat_ratio_pct: data.left_arm_fat_ratio_pct ?? null,
        right_arm_fat_ratio_pct: data.right_arm_fat_ratio_pct ?? null,
        left_arm_fat_mass_kg: data.left_arm_fat_mass_kg ?? null,
        right_arm_fat_mass_kg: data.right_arm_fat_mass_kg ?? null,
        left_arm_muscle_ratio_pct: data.left_arm_muscle_ratio_pct ?? null,
        right_arm_muscle_ratio_pct: data.right_arm_muscle_ratio_pct ?? null,
        left_arm_muscle_mass_kg: data.left_arm_muscle_mass_kg ?? null,
        right_arm_muscle_mass_kg: data.right_arm_muscle_mass_kg ?? null,
        left_leg_fat_ratio_pct: data.left_leg_fat_ratio_pct ?? null,
        right_leg_fat_ratio_pct: data.right_leg_fat_ratio_pct ?? null,
        left_leg_fat_mass_kg: data.left_leg_fat_mass_kg ?? null,
        right_leg_fat_mass_kg: data.right_leg_fat_mass_kg ?? null,
        left_leg_muscle_ratio_pct: data.left_leg_muscle_ratio_pct ?? null,
        right_leg_muscle_ratio_pct: data.right_leg_muscle_ratio_pct ?? null,
        left_leg_muscle_mass_kg: data.left_leg_muscle_mass_kg ?? null,
        right_leg_muscle_mass_kg: data.right_leg_muscle_mass_kg ?? null,
        flags: data.flags ?? {},
      };
